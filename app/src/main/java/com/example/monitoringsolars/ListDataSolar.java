                        ...
                        try {
                            ...
                            if(status == true){
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    news.setVolt(jsonObject.getString("volt"));
                                    news.setAmpere(jsonObject.getString("amper"));
                                    news.setWatt(jsonObject.getString("watt"));
                                    news.setKwh(jsonObject.getString("kwh"));
                                    news.setHertz(jsonObject.getString("hertz"));
